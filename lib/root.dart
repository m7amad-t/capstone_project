...
import 'package:shop_owner/utils/orientationManager.dart';
...
class _RootPageState extends State<RootPage> {
  ...
  void orientationManager(BuildContext context) {
    final String location = GoRouterState.of(context).uri.toString();
    List<String> freeScreens = [
      AppRoutes.totalRevenue,
      AppRoutes.totalSale,
      // AppRoutes.saleAnalytics,
      AppRoutes.productAnalytics,
      AppRoutes.categoryAnalytics,
      AppRoutes.expensesAnalytics,
      AppRoutes.trendingAnalytics,
    ];

    for (final key in freeScreens) {
      if (location.endsWith(key)) {
        AppOrientationManager.freeOrients(); 
        return ; 
      }
    }


    AppOrientationManager.appDefault(); 
  }

  @override
  Widget build(BuildContext context) {

    orientationManager(context); 
