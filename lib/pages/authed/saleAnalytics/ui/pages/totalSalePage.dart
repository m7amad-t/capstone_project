...
class _TotalSalePageState extends State<TotalSalePage> {
  ...
  Future<void> loadData() async {
    ...
    data = await _service.getTotalSale(_selectedDateRange);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          TotalSection(
            lable: context.translate.total_sale,
  ...
  List<CartesianSeries<MonthSale, String>> _buildAreaSeries(
      BuildContext context) {
    return <CartesianSeries<MonthSale, String>>[
      SplineAreaSeries<MonthSale, String>(
