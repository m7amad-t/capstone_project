...
class _ProductManagementPageState extends State<ProductManagementPage> {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(onPressed: (){
        Navigator.of(context).push(
          DialogRoute(context: context, builder: (context) => BlocBuilder<ProductBloc, ProductBlocState>(
            builder: (context, state) {
              ...
              return ProductEditorPage(product: null, categories: categories);
            },
          ),)
        ); 
      ...
      appBar: AppBar(
        title: Text(context.translate.product_management),
      ),
  ...
  Widget _productFilterSection(final TextTheme _textStyle) {
    return BlocBuilder<ProductBloc, ProductBlocState>(
      builder: (context, state) {
        if (state is GotProducts) {
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      context.read<ProductBloc>().add(
                          SelectCategory(category: state.categories[index]));
                    },
                    child: Text(
